...
from allegro.dataset.presto_datasets import Presto_dataset
...
def getdataset(args):
    ...
    if args.dataset == 't2v':
        ...
        tokenizer = T5Tokenizer.from_pretrained(args.tokenizer, cache_dir=args.cache_dir)
        return Presto_dataset(args, transform=transform, temporal_sample=temporal_sample, tokenizer=tokenizer)
