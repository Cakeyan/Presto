...
from allegro.models.transformers.block import to_2tuple, BasicTransformerBlock, AdaLayerNormSingle, PrestoTransformerBlock
...
class AllegroTransformer3DModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        if encoder_attention_mask is not None and encoder_attention_mask.ndim == 3:  
            ...
            if self.num_prompts > 1:
                encoder_attention_mask_vid = encoder_attention_mask
            elif encoder_attention_mask.numel() > 0:
                encoder_attention_mask_vid = rearrange(encoder_attention_mask, 'b 1 l -> (b 1) 1 l')
            else:
    ...
    def _operate_on_patched_inputs(self, hidden_states, encoder_hidden_states, timestep, added_cond_kwargs, batch_size):
            ...
            if self.caption_projection is not None:
                ...
                if self.num_prompts > 1:
                    encoder_hidden_states_vid = rearrange(encoder_hidden_states, 'b n l d -> b n l d')
                else:
