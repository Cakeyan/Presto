...
def main(args):
    ...
    def initialize_model(dit_config, dit):
        ...
        if dit_config is not None:
            ...
            config["num_prompts"] = args.num_prompts # for presto
...
if __name__ == "__main__":
    ...
    # multiple prompts
    parser.add_argument("--num_prompts", type=int, default=1, help="How many prompts used in the training")
    parser.add_argument("--stride_per_prompt", type=int, help="The number of frames stride per prompt")
